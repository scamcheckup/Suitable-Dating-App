...
-- Function to clean up old votes (optional, for data management)
CREATE OR REPLACE FUNCTION cleanup_old_vibe_votes()
RETURNS INTEGER AS $$
DECLARE
  deleted_count INTEGER;
BEGIN
  -- Delete votes older than 90 days
  DELETE FROM vibe_votes 
